...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--filterVocab', type=int, default=6, help='remove rarelly used words (by default words used only once). 0 to keep all words.')
        ...
        trainingArgs.add_argument('--numEpochs', type=int, default=75, help='maximum number of epochs to run')
